...
} from "../controllers/Admin/countController.js";
...
import {
  ...
  getServicesWithNullParentId,
} from "../controllers/API/HomeController.js";
import {
  bookService,
  deleteBookingById,
  getAllBookings,
  getAllProcessingBookings,
} from "../controllers/API/BookServiceController.js";
import {
  createguide,
  deleteguideById,
  getAllguides,
  getguideById,
  updateguideById,
} from "../controllers/Admin/GuideController.js";
import { uploadGuide } from "../helper/guidImages.js";
import {
  createGuideTypes,
  getAllguideTypes,
  getGuideTypesByGuideId,
  getGuideTypesById,
} from "../controllers/Admin/GuideTypeController.js";
import {
  allSteps,
  createGuideSteps,
...
import {
  createBookingAssign,
  deleteBookingAssignById,
  getAllUserBookingAcceptAssignments,
  getAllUserBookingAssignments,
  getAllUserBookingCompleteAssignments,
  getAllUserBookingRejectAssignments,
  getBookingAssignById,
  updateBookingAssignById,
  updateBookingAssignStatus,
} from "../controllers/Admin/BookingAssignController.js";
import {
  getAllAcceptBooking,
  getAllCompletedBooking,
  getAllPendingBooking,
  getAllRejectBooking,
} from "../controllers/Admin/BookingAdminAssigned.js";
import {
  forgotPassword,
  resetPassword,
} from "../controllers/Admin/UserController.js";
...
router.get("/totalUser", verifyToken, checkAdminRole, getTotalUsers);
router.get("/totalStaff", verifyToken, checkAdminRole, getTotalStaff);
router.get("/dashboardStats", verifyToken, getDashboardStats);
router.get("/staffStats", verifyToken, getStaffDashboardStats);
