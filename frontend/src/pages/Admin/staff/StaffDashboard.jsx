        ...
        <Link to="dashboard">
          ...
          <ul className="w-full">
            ...
            <li className="text-[16px] my-3 font-light  text-gray-300 w-full hover:text-white hover:bg-slate-500 px-5 py-3">
                <i class="fa-solid fa-dice-d20 mr-1 text-sm"></i> Pending Client
                </li>
              </Link>
              <Link to="completedAssigned">
            <li className="text-[16px] my-3 font-light  text-gray-300 w-full hover:text-white hover:bg-slate-500 px-5 py-3">
                <i class="fa-solid fa-dice-d20 mr-1 text-sm"></i> Completed Client
                </li>
              </Link>
              <Link to="acceptAssigned">
            <li className="text-[16px] my-3 font-light  text-gray-300 w-full hover:text-white hover:bg-slate-500 px-5 py-3">
                <i class="fa-solid fa-dice-d20 mr-1 text-sm"></i> Accepted Client
                </li>
              </Link>
              <Link to="rejectAssigned">
            <li className="text-[16px] my-3 font-light  text-gray-300 w-full hover:text-white hover:bg-slate-500 px-5 py-3">
                <i class="fa-solid fa-dice-d20 mr-1 text-sm"></i> Rejected Client
                </li>
              </Link>
