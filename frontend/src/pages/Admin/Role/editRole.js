...
function EditRole() {
  ...
  return (
    <div className="container   mx-auto px-4 my-6">
      ...
      <h2 className="text-3xl py-6 text-gray-700   text-center font-semibold ">Edit Role</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="pt-2 pb-6 mx-4 grid place-items-center">
          ...
          {/* <Link to="/admin/roles" className="ml-2 text-blue-500 hover:text-blue-600">Cancel</Link> */}
        </div>
      </form>
      </div>
    </div>
