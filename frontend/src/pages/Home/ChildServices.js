                ...
                <div className="mt-auto flex flex-col gap-4">
                  <div className="flex items-center justify-between border-t border-slate-100 pt-4 md:pt-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <a
                        href={`https://wa.me/9851037595?text=${encodeURIComponent(`Hello, I would like to inquire about the service: ${service.name}. Link: ${window.location.origin}/booking/${service.id}`)}`}
                        target="_blank"
