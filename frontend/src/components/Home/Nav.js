            ...
            <div className="grid grid-cols-2 text-sm  w-fit md:gap-4 ">
              {isLoggedIn() ? (
                <button
                  ...
                  className="text-white w-20 md:w-fit mr-6 md:mr-auto text-[9px] md:text-[14px] font-semibold px-4 py-2 rounded-md  hover:bg-blue-600 border hover:border-blue-600 border-blue-600 bg-blue-500"
                >
                  Logout
                </button>
              ) : (
